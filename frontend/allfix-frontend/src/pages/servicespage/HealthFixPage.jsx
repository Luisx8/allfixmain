        ...
        <Box sx={{ pt: { xs: 3, md: 4 }, pb: { xs: 4, md: 12 }, bgcolor: 'white', width: '100%' }}>
          <Container maxWidth="lg">
                ...
                {healthfixServices.map((service, index) => (
                  <Box key={index} sx={{
                    ...
                    '&:hover': {
                      ...
                      boxShadow: '0 16px 32px rgba(194, 24, 91, 0.1)',
                    }
                  }}>
            ...
            <Box sx={{
              ...
              <Box sx={{ position: 'absolute', top: -60, right: -60, width: 240, height: 240, borderRadius: '50%', bgcolor: 'rgba(244, 143, 177, 0.08)', pointerEvents: 'none' }} />
              <Box sx={{ position: 'absolute', bottom: -40, left: -40, width: 180, height: 180, borderRadius: '50%', bgcolor: 'rgba(194, 24, 91, 0.07)', pointerEvents: 'none' }} />
              <Box sx={{ position: 'relative', zIndex: 1, p: { xs: 4, md: 6 }, display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', justifyContent: 'space-between', gap: 4 }}>
                <Box sx={{ flex: 1 }}>
                  <Typography variant="h3" sx={{ fontSize: { xs: '1.6rem', md: '2.2rem' }, fontWeight: 900, color: 'white', lineHeight: 1.15, mb: 1.5 }}>Ready to Live Healthier?</Typography>
                  <Typography sx={{ color: 'rgba(255,255,255,0.65)', fontSize: '0.97rem', lineHeight: 1.7, maxWidth: 460 }}>Book a HealthFix expert today. Improve the quality and safety of your environment with our specialized health services.</Typography>
                </Box>
