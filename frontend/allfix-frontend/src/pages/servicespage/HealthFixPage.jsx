...
const healthfixServices = [
  { title: 'Indoor Air Quality Testing', description: 'Checking for excessive dust, mold spores, or poor ventilation in enclosed spaces.' },
  { title: 'Water Potability Testing', description: 'Sampling faucet or tank water to ensure it is safe for consumption and bathing.' },
  { title: 'Allergen Reduction', description: 'Specialized cleaning processes targeting pet dander, pollen, and severe dust buildup.' },
  { title: 'Pest Control', description: 'Preventive treatments against termites, cockroaches, rodents, and mosquitoes.' },
  { title: 'Ergonomic Workspace Setup', description: 'Adjusting home-office desks, chairs, and monitors to prevent back and neck strain.' },
  { title: 'Health Services', description: 'Various health and wellness services for safer living environments.' },
];
  ...
  return (
    <>
      ...
      <Box sx={{ bgcolor: '#f0f4f8', minHeight: '100vh', width: '100%' }}>
        <Box sx={{ position: 'relative', minHeight: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center', pt: { xs: 12, md: 10 }, pb: { xs: 6, md: 8 }, px: 3, background: 'linear-gradient(135deg, #f8bbd0 0%, #f48fb1 100%)', overflow: 'visible' }}>
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
              <FavoriteBorderIcon sx={{ fontSize: 80, color: '#c2185b' }} />
            </Box>
            <Typography variant="h1" fontWeight="900" sx={{ fontSize: { xs: '2.5rem', md: '4rem' }, lineHeight: 1.2, mb: 3, letterSpacing: '-0.02em', color: '#10355f' }}>HealthFix</Typography>
            <Typography sx={{ fontSize: { xs: '1.1rem', md: '1.3rem' }, lineHeight: 1.6, maxWidth: '700px', mx: 'auto', color: '#555' }}>Health & Wellness Services | Safe • Clean • Healthy</Typography>
          </Container>
        </Box>

        <Box sx={{ pt: { xs: 6, md: 8 }, pb: { xs: 4, md: 12 }, bgcolor: 'white', width: '100%' }}>
          <Container maxWidth="md">
            <Section title="About HealthFix">
