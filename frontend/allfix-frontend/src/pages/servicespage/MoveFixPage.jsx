...
const movefixServices = [
  { title: 'Full-Service Packing', description: 'Supplying boxes, bubble wrap, and expertly packing fragile items prior to moving day.' },
  { title: 'Loading & Transport', description: 'Safe lifting and secure transportation via closed vans or trucks.' },
  { title: 'Appliance Relocation', description: 'Specialized handling for heavy/delicate items like refrigerators, washing machines, and large TVs.' },
  { title: 'Unpacking & Setup', description: 'Helping clients unbox items and place them in their designated rooms.' },
  { title: 'Storage Solutions', description: 'Short-term storage box rentals for items during home staging or delayed move-ins.' },
  { title: 'Professional Moving', description: 'Complete household and commercial moving services with careful handling.' },
];
  ...
  return (
    <>
      ...
      <Box sx={{ bgcolor: '#f0f4f8', minHeight: '100vh', width: '100%' }}>
        <Box sx={{ position: 'relative', minHeight: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center', pt: { xs: 12, md: 10 }, pb: { xs: 6, md: 8 }, px: 3, background: 'linear-gradient(135deg, #f3e5ab 0%, #ffe082 100%)', overflow: 'visible' }}>
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
              <LocalShippingIcon sx={{ fontSize: 80, color: '#ff6f00' }} />
            </Box>
            <Typography variant="h1" fontWeight="900" sx={{ fontSize: { xs: '2.5rem', md: '4rem' }, lineHeight: 1.2, mb: 3, letterSpacing: '-0.02em', color: '#10355f' }}>MoveFix</Typography>
            <Typography sx={{ fontSize: { xs: '1.1rem', md: '1.3rem' }, lineHeight: 1.6, maxWidth: '700px', mx: 'auto', color: '#555' }}>Professional Moving Solutions | Reliable • Efficient • Careful</Typography>
          </Container>
        </Box>

        <Box sx={{ pt: { xs: 6, md: 8 }, pb: { xs: 4, md: 12 }, bgcolor: 'white', width: '100%' }}>
          <Container maxWidth="md">
            <Section title="About MoveFix">
              ...
              <Typography sx={{ color: '#555', lineHeight: 1.8 }}>
                With professional movers, quality equipment, and proven logistics expertise, we handle your move with care and efficiency.
              </Typography>
            </Section>
