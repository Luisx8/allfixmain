...
const techfixServices = [
  { title: 'Hardware Setup & Upgrades', description: 'Custom PC building, hardware installations, and upgrading RAM/SSDs for better performance.' },
  { title: 'Network & Wi-Fi Solutions', description: 'Local area network (LAN) configuration, eliminating dead zones, and setting up mesh Wi-Fi systems.' },
  { title: 'Printer & Peripherals', description: 'Printer troubleshooting, wireless printing setup, and scanner configuration.' },
  { title: 'Smart Home Setup', description: 'Installing and configuring smart locks, Wi-Fi CCTV cameras, and voice assistants.' },
  { title: 'Data Recovery & Security', description: 'Removing malware/viruses and helping clients back up important files to the cloud or external drives.' },
  { title: 'IT Support Services', description: 'Various IT and gadget support services for homes and offices.' },
];
  ...
  return (
    <>
      ...
      <Box sx={{ bgcolor: '#f0f4f8', minHeight: '100vh', width: '100%' }}>
        <Box sx={{ position: 'relative', minHeight: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center', pt: { xs: 12, md: 10 }, pb: { xs: 6, md: 8 }, px: 3, background: 'linear-gradient(135deg, #f0f4c3 0%, #dcedc8 100%)', overflow: 'visible' }}>
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
              <MemoryIcon sx={{ fontSize: 80, color: '#689f38' }} />
            </Box>
            <Typography variant="h1" fontWeight="900" sx={{ fontSize: { xs: '2.5rem', md: '4rem' }, lineHeight: 1.2, mb: 3, letterSpacing: '-0.02em', color: '#10355f' }}>TechFix</Typography>
            <Typography sx={{ fontSize: { xs: '1.1rem', md: '1.3rem' }, lineHeight: 1.6, maxWidth: '700px', mx: 'auto', color: '#555' }}>IT & Gadget Support Services | Reliable • Fast • Expert</Typography>
          </Container>
        </Box>

        <Box sx={{ pt: { xs: 6, md: 8 }, pb: { xs: 4, md: 12 }, bgcolor: 'white', width: '100%' }}>
          <Container maxWidth="md">
            <Section title="About TechFix">
