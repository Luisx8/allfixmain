...
const petfixServices = [
  { title: 'Mobile Pet Grooming', description: 'Bathing, nail trimming, and haircuts for dogs and cats done right outside the client\'s home.' },
  { title: 'Aquarium Maintenance', description: 'Water parameter testing, glass cleaning, filter changes, and specialized care for saltwater setups, including reef fish and anemone health.' },
  { title: 'Pet Sitting & Dog Walking', description: 'Reliable drop-in visits or scheduled walks for busy owners.' },
  { title: 'Enclosure Deep Cleaning', description: 'Sanitizing litter boxes, birdcages, or reptile terrariums.' },
  { title: 'Pet-Proofing', description: 'Installing safety gates, securing loose wires, and removing toxic indoor plants.' },
  { title: 'Pet Care Services', description: 'Various pet care and grooming services for your beloved pets.' },
];
  ...
  return (
    <>
      ...
      <Box sx={{ bgcolor: '#f0f4f8', minHeight: '100vh', width: '100%' }}>
        <Box sx={{ position: 'relative', minHeight: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center', pt: { xs: 12, md: 10 }, pb: { xs: 6, md: 8 }, px: 3, background: 'linear-gradient(135deg, #ffccbc 0%, #ffab91 100%)', overflow: 'visible' }}>
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
              <PetsIcon sx={{ fontSize: 80, color: '#d84315' }} />
            </Box>
            <Typography variant="h1" fontWeight="900" sx={{ fontSize: { xs: '2.5rem', md: '4rem' }, lineHeight: 1.2, mb: 3, letterSpacing: '-0.02em', color: '#10355f' }}>PetFix</Typography>
            <Typography sx={{ fontSize: { xs: '1.1rem', md: '1.3rem' }, lineHeight: 1.6, maxWidth: '700px', mx: 'auto', color: '#555' }}>Pet Care & Grooming Services | Loving • Professional • Trustworthy</Typography>
          </Container>
        </Box>

        <Box sx={{ pt: { xs: 6, md: 8 }, pb: { xs: 4, md: 12 }, bgcolor: 'white', width: '100%' }}>
          <Container maxWidth="md">
            <Section title="About PetFix">
              <Typography sx={{ mb: 2, color: '#555', lineHeight: 1.8 }}>
                PetFix is AllFix.ph's dedicated pet care and grooming division. We provide comprehensive pet grooming, boarding, and wellness services for dog and cat owners across Metro Manila. Your pets are treated with love, care, and professional expertise.
              </Typography>
              <Typography sx={{ color: '#555', lineHeight: 1.8 }}>
                From professional grooming and boarding to wellness consultations, we ensure your furry family members receive the best care and attention they deserve.
              </Typography>
            </Section>
