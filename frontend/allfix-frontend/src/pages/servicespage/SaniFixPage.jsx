          ...
          <Container maxWidth="lg">
                ...
                {sanifixServices.map((service, index) => (
                  <Box key={index} sx={{
                    ...
                    '&:hover': {
                      ...
                      boxShadow: '0 16px 32px rgba(2, 132, 199, 0.1)',
                    }
                  }}>
            ...
            <Box sx={{
              ...
              <Box sx={{ position: 'relative', zIndex: 1, p: { xs: 4, md: 6 }, display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', justifyContent: 'space-between', gap: 4 }}>
                <Box sx={{ flex: 1 }}>
                  <Typography variant="h3" sx={{ fontSize: { xs: '1.6rem', md: '2.2rem' }, fontWeight: 900, color: 'white', lineHeight: 1.15, mb: 1.5 }}>Ready to Clean Up?</Typography>
                  <Typography sx={{ color: 'rgba(255,255,255,0.65)', fontSize: '0.97rem', lineHeight: 1.7, maxWidth: 460 }}>Book a SaniFix professional today. Enjoy fresh laundry and a sparkling clean environment. Impeccable service — guaranteed.</Typography>
                </Box>
