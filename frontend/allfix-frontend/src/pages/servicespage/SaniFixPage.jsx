...
const sanifixServices = [
  { title: 'Laundry Pick-Up & Delivery', description: 'Convenient by-the-kilo service where riders pick up dirty laundry and return it freshly washed and neatly folded.' },
  { title: 'Dry Cleaning & Pressing', description: 'Professional care for delicate fabrics, suits, gowns, and corporate wear to keep them crisp and pristine.' },
  { title: 'Heavy Duty Linen Cleaning', description: 'Deep washing for bulky items like thick comforters, heavy curtains, rugs, and sofa covers.' },
  { title: 'Move-In / Move-Out Cleaning', description: 'Scrubbing empty spaces top-to-bottom before new tenants arrive.' },
  { title: 'Upholstery & Mattress Shampooing', description: 'Deep extraction cleaning for sofas, carpets, office chairs, and beds to remove stains and dust mites.' },
  { title: 'Misting & Fogging', description: 'Hospital-grade antibacterial and antiviral disinfection for homes and offices.' },
];
  ...
  return (
    <>
      ...
      <Box sx={{ bgcolor: '#f0f4f8', minHeight: '100vh', width: '100%' }}>
        <Box sx={{ position: 'relative', minHeight: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center', pt: { xs: 12, md: 10 }, pb: { xs: 6, md: 8 }, px: 3, background: 'linear-gradient(135deg, #eaf2fc 0%, #d4e8f7 100%)', overflow: 'visible' }}>
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
              <WaterDropIcon sx={{ fontSize: 80, color: '#2E5BA8' }} />
            </Box>
            <Typography variant="h1" fontWeight="900" sx={{ fontSize: { xs: '2.5rem', md: '4rem' }, lineHeight: 1.2, mb: 3, letterSpacing: '-0.02em', color: '#10355f' }}>SaniFix</Typography>
            <Typography sx={{ fontSize: { xs: '1.1rem', md: '1.3rem' }, lineHeight: 1.6, maxWidth: '700px', mx: 'auto', color: '#555' }}>Deep Cleaning & Sanitization Services | Professional • Eco-Friendly • Thorough</Typography>
          </Container>
        </Box>

        <Box sx={{ pt: { xs: 6, md: 8 }, pb: { xs: 4, md: 12 }, bgcolor: 'white', width: '100%' }}>
          <Container maxWidth="md">
            <Section title="About SaniFix">
              <Typography sx={{ mb: 2, color: '#555', lineHeight: 1.8 }}>
                SaniFix is AllFix.ph's professional deep cleaning and sanitization division. We provide comprehensive cleaning solutions for residential and commercial properties across Metro Manila. From routine cleaning to specialized sanitization, our trained team ensures your spaces are clean, healthy, and safe.
              </Typography>
              <Typography sx={{ color: '#555', lineHeight: 1.8 }}>
                With expertise in eco-friendly cleaning practices and advanced sanitization techniques, we guarantee thorough results without compromising health and environmental safety.
              </Typography>
            </Section>
