...
const homefixServices = [
  { title: 'Handyman Services', description: 'Hanging shelves, mounting TVs, assembling flat-pack furniture, and replacing door locks.' },
  { title: 'Minor Plumbing', description: 'Fixing leaky faucets, unclogging sinks/toilets, and replacing showerheads or bidets.' },
  { title: 'Electrical Works', description: 'Changing lighting fixtures, replacing busted outlets, and rewiring minor circuits.' },
  { title: 'Aesthetic Touch-ups', description: 'Repainting walls, replacing cracked floor tiles, and re-grouting bathrooms.' },
  { title: 'Roof & Ceiling Repair', description: 'Patching up roof leaks, sealing gutters, and replacing water-damaged ceiling panels.' },
  { title: 'General Repairs', description: 'Various home maintenance and repair tasks for comfort and safety.' },
];
  ...
  return (
    <>
      ...
      <Box sx={{ bgcolor: '#f0f4f8', minHeight: '100vh', width: '100%' }}>
        <Box sx={{ position: 'relative', minHeight: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center', pt: { xs: 12, md: 10 }, pb: { xs: 6, md: 8 }, px: 3, background: 'linear-gradient(135deg, #ffe082 0%, #ffd54f 100%)', overflow: 'visible' }}>
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
              <BuildIcon sx={{ fontSize: 80, color: '#f57f17' }} />
            </Box>
            <Typography variant="h1" fontWeight="900" sx={{ fontSize: { xs: '2.5rem', md: '4rem' }, lineHeight: 1.2, mb: 3, letterSpacing: '-0.02em', color: '#10355f' }}>HomeFix</Typography>
            <Typography sx={{ fontSize: { xs: '1.1rem', md: '1.3rem' }, lineHeight: 1.6, maxWidth: '700px', mx: 'auto', color: '#555' }}>Home Repairs & Renovation Services | Quality • Reliable • Professional</Typography>
          </Container>
        </Box>

        <Box sx={{ pt: { xs: 6, md: 8 }, pb: { xs: 4, md: 12 }, bgcolor: 'white', width: '100%' }}>
          <Container maxWidth="md">
            <Section title="About HomeFix">
              ...
              <Typography sx={{ color: '#555', lineHeight: 1.8 }}>
                With years of experience in plumbing, electrical work, carpentry, and general repairs, we deliver reliable solutions that keep your home comfortable and safe.
              </Typography>
            </Section>
