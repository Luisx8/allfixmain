...
const homefixServices = [
  { title: 'Handyman Services', description: 'Hanging shelves, mounting TVs, assembling flat-pack furniture, and replacing door locks.', tag: 'Assembly', image: 'https://images.unsplash.com/photo-1581141849291-1125c7b692b5?w=400&h=400&fit=crop' },
  { title: 'Minor Plumbing', description: 'Fixing leaky faucets, unclogging sinks/toilets, and replacing showerheads or bidets.', tag: 'Plumbing', image: 'https://images.unsplash.com/photo-1607472586893-edb57cb31322?w=400&h=400&fit=crop' },
  { title: 'Electrical Works', description: 'Changing lighting fixtures, replacing busted outlets, and rewiring minor circuits.', tag: 'Electrical', image: 'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=400&h=400&fit=crop' },
  { title: 'Aesthetic Touch-ups', description: 'Repainting walls, replacing cracked floor tiles, and re-grouting bathrooms.', tag: 'Finishing', image: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400&h=400&fit=crop' },
  { title: 'Roof & Ceiling Repair', description: 'Patching up roof leaks, sealing gutters, and replacing water-damaged ceiling panels.', tag: 'Structural', image: 'https://images.unsplash.com/photo-1605810230434-7631ac76ec81?w=400&h=400&fit=crop' },
  { title: 'General Repairs', description: 'Various home maintenance and repair tasks for comfort and safety.', tag: 'Maintenance', image: 'https://images.unsplash.com/photo-1504148455328-c376907d081c?w=400&h=400&fit=crop' },
];
              ...
              {footerPills.map(pill => (
                <Box
                  ...
                  sx={{
                    ...
                    px: 1,
                    py: 2,
                    bgcolor: pill.name === 'HomeFix' ? 'rgba(255,255,255,0.15)' : '#ffffff',
                    color: pill.name === 'HomeFix' ? 'white' : '#10355f',
                    borderRadius: '12px',
                    cursor: 'pointer',
                    transition: 'all 0.2s ease',
                    boxShadow: pill.name === 'HomeFix' ? 'none' : '0 4px 12px rgba(0,0,0,0.15)',
                  }}
                >
          ...
          <Container maxWidth="lg">
                ...
                {footerPills.map(pill => (
                  <Box
                    ...
                    sx={{
                      ...
                      px: { xs: 1.5, md: 2 },
                      py: { xs: 0.6, md: 0.8 },
                      bgcolor: pill.name === 'HomeFix' ? '#10355f' : '#ffffff',
                      color: pill.name === 'HomeFix' ? 'white' : '#334155',
                      border: '1px solid',
                      borderColor: pill.name === 'HomeFix' ? '#10355f' : '#e2e8f0',
                      borderRadius: '50px',
                      cursor: 'pointer',
                      transition: 'all 0.3s ease',
                      boxShadow: pill.name === 'HomeFix' ? '0 8px 16px rgb(255, 255, 255)' : '0 2px 4px rgba(0,0,0,0.04)',
                      '&:hover': {
                        bgcolor: pill.name === 'HomeFix' ? '#10355f' : '#f8fafc',
                        borderColor: pill.name === 'HomeFix' ? '#10355f' : '#cbd5e1',
            ...
            <Box sx={{ mb: 10, display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: { xs: 4, md: 6 }, alignItems: 'center' }}>
              <Box sx={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Box sx={{
                  ...
                  borderRadius: '16px',
                  overflow: 'hidden',
                  boxShadow: '0 16px 32px rgba(245, 127, 23, 0.15)',
                  border: '4px solid #fff8e1'
                }}>
                  <Box
                    component="img"
                    src="/images/homefix.jpg"
                    alt="HomeFix"
              ...
              <Box>
                <Typography variant="h2" sx={{ fontSize: { xs: '1.8rem', md: '2.2rem' }, fontWeight: 900, color: '#10355f', mb: 2, lineHeight: 1.2 }}>
                  About Home<span style={{ color: '#017550' }}>F</span><span style={{ color: '#fcbc26' }}>i</span><span style={{ color: '#d8242b' }}>x</span>
                </Typography>
                <Typography sx={{ mb: 3, color: '#666', lineHeight: 1.8, fontSize: '1rem' }}>
                  HomeFix is AllFix.ph's comprehensive home repair and renovation division. We handle all types of home maintenance and improvement projects across Metro Manila. From minor repairs to major renovations, our skilled technicians ensure quality workmanship.
                </Typography>
                <Typography sx={{ mb: 4, color: '#666', lineHeight: 1.8, fontSize: '1rem' }}>
                  With years of experience in plumbing, electrical work, carpentry, and general repairs, we deliver reliable solutions that keep your home comfortable, functional, and safe.
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ mb: 10 }}>
              ...
              <Box sx={{
                ...
                {homefixServices.map((service, index) => (
                  <Box key={index} sx={{
                    display: 'flex',
                    flexDirection: 'column',
                    bgcolor: '#f8fafc',
            ...
            <Box sx={{
              ...
              <Box sx={{ position: 'absolute', top: -60, right: -60, width: 200, height: 200, borderRadius: '50%', bgcolor: 'rgba(253, 216, 53, 0.08)', pointerEvents: 'none' }} />
              <Box sx={{ position: 'absolute', bottom: -40, left: -40, width: 150, height: 150, borderRadius: '50%', bgcolor: 'rgba(245, 127, 23, 0.07)', pointerEvents: 'none' }} />
              ...
              <Box sx={{
                ...
                <Box sx={{ flex: 1 }}>
                  ...
                  <Typography sx={{ color: 'rgba(255,255,255,0.7)', fontSize: { xs: '0.85rem', md: '0.95rem' }, lineHeight: 1.6, maxWidth: 500 }}>
                    Book a HomeFix professional today. Get your property repairs done right the first time. Quality workmanship — guaranteed.
                  </Typography>
                </Box>
