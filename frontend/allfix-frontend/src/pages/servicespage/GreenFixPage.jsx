...
const greenfixServices = [
  { title: 'Solar Panel Maintenance', description: 'Professional cleaning of solar arrays to ensure maximum energy absorption.' },
  { title: 'Waste Segregation Setup', description: 'Designing and installing proper recycling and waste sorting stations for households or condos.' },
  { title: 'Composting Solutions', description: 'Setting up odorless Bokashi or worm-composting bins for kitchen scraps.' },
  { title: 'Energy Audits', description: 'Inspecting homes to suggest LED retrofitting, smart plugs, and insulation improvements to lower electricity bills.' },
  { title: 'Rainwater Harvesting Setup', description: 'Installing simple collection barrels for garden irrigation or outdoor washing.' },
  { title: 'Eco Solutions', description: 'Various sustainability and environmental protection services.' },
];
  ...
  return (
    <>
      ...
      <Box sx={{ bgcolor: '#f0f4f8', minHeight: '100vh', width: '100%' }}>
        <Box sx={{ position: 'relative', minHeight: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center', pt: { xs: 12, md: 10 }, pb: { xs: 6, md: 8 }, px: 3, background: 'linear-gradient(135deg, #c8e6c9 0%, #a5d6a7 100%)', overflow: 'visible' }}>
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
              <SpaIcon sx={{ fontSize: 80, color: '#2e7d32' }} />
            </Box>
            <Typography variant="h1" fontWeight="900" sx={{ fontSize: { xs: '2.5rem', md: '4rem' }, lineHeight: 1.2, mb: 3, letterSpacing: '-0.02em', color: '#10355f' }}>GreenFix</Typography>
            <Typography sx={{ fontSize: { xs: '1.1rem', md: '1.3rem' }, lineHeight: 1.6, maxWidth: '700px', mx: 'auto', color: '#555' }}>Eco & Sustainability Services | Responsible • Sustainable • Green</Typography>
          </Container>
        </Box>

        <Box sx={{ pt: { xs: 6, md: 8 }, pb: { xs: 4, md: 12 }, bgcolor: 'white', width: '100%' }}>
          <Container maxWidth="md">
            <Section title="About GreenFix">
              ...
              <Typography sx={{ color: '#555', lineHeight: 1.8 }}>
                With expertise in waste reduction, energy efficiency, and eco-friendly operations, we help you minimize your environmental footprint while maintaining comfort and functionality.
              </Typography>
            </Section>
