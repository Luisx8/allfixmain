              ...
              {footerPills.map(pill => (
                <Box
                  ...
                  sx={{
                    ...
                    px: 1,
                    py: 2,
                    bgcolor: pill.name === 'MoveFix' ? 'rgba(255,255,255,0.15)' : '#ffffff',
                    color: pill.name === 'MoveFix' ? 'white' : '#10355f',
                    borderRadius: '12px',
                    cursor: 'pointer',
                    transition: 'all 0.2s ease',
                    boxShadow: pill.name === 'MoveFix' ? 'none' : '0 4px 12px rgba(0,0,0,0.15)',
                  }}
                >
        ...
        <Box sx={{ pt: { xs: 3, md: 4 }, pb: { xs: 4, md: 12 }, bgcolor: 'white', width: '100%' }}>
          <Container maxWidth="lg">
            ...
            <Box sx={{
              ...
              <Box sx={{ position: 'absolute', top: -60, right: -60, width: 200, height: 200, borderRadius: '50%', bgcolor: 'rgba(255, 179, 0, 0.08)', pointerEvents: 'none' }} />
              <Box sx={{ position: 'absolute', bottom: -40, left: -40, width: 150, height: 150, borderRadius: '50%', bgcolor: 'rgba(255, 111, 0, 0.07)', pointerEvents: 'none' }} />
              ...
              <Box sx={{
                ...
                <Box sx={{ flex: 1 }}>
                  ...
                  <Typography sx={{ color: 'rgba(255,255,255,0.7)', fontSize: { xs: '0.85rem', md: '0.95rem' }, lineHeight: 1.6, maxWidth: 500 }}>
                    Book a MoveFix team today. Experience a hassle-free relocation with our professional movers. We handle your belongings with the utmost care.
                  </Typography>
                </Box>
