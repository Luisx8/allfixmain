      ...
      >
        <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', px: { xs: 2, sm: 4, md: 5 }, minHeight: '64px' }}>
          ...
          <Box sx={{ display: 'flex', gap: { xs: 1, lg: 1.5 }, alignItems: 'center', mr: { xl: 4, lg: 2 } }}>
            ...
            <Button
              onClick={() => { navigate('/personnel-register'); window.scrollTo(0, 0); }}
              sx={{
                px: 2, py: 1, borderRadius: 1, fontSize: '0.95rem', fontWeight: 600, textTransform: 'none',
                color: isScrolled ? BRAND : 'rgba(255,255,255,0.9)',
                display: { xs: 'none', sm: 'flex' },
            ...
            <IconButton
              sx={{ display: { xs: 'flex', sm: 'none' }, color: isScrolled ? BRAND : 'white' }}
      ...
      <Drawer 
        ...
        PaperProps={{
          sx: {
            width: '100%',
            height: 'auto', 
            maxHeight: '50dvh', // Limits to half the screen height
            // Semi-transparent gradient
            background: 'linear-gradient(to bottom, rgba(25, 51, 84, 0.9) 0%, rgba(17, 38, 61, 0.95) 100%)', 
            backdropFilter: 'blur(10px)', // Adds a blur effect behind the menu
            color: 'white',
      ...
      >
        <Box sx={{ p: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
             <Box component="img" src="/ALLFIXLOGO.png" sx={{ width: 40, height: 40, borderRadius: '50%' }} />
             <Box>
                <Typography sx={{ fontWeight: 800, fontSize: '1.2rem', lineHeight: 1 }}>AllFix.ph</Typography>
                <Typography sx={{ fontSize: '0.65rem', letterSpacing: 1, color: 'rgba(255,255,255,0.8)' }}>YOUR ALL-IN-ONE SERVICE</Typography>
             </Box>
          </Box>
        ...
        <Box sx={{ p: 4, display: 'flex', flexDirection: 'column', gap: 4, mt: 2 }}>
           <Typography variant="h6" fontWeight="bold" sx={{ cursor: 'pointer', transition: 'color 0.2s', '&:hover': { color: '#017550' } }} onClick={() => { setMobileMenuOpen(false); navigate('/'); window.scrollTo(0,0); }}>
             Back to Home
           </Typography>
           <Typography variant="h6" fontWeight="bold" sx={{ cursor: 'pointer', transition: 'color 0.2s', '&:hover': { color: '#017550' } }} onClick={() => { setMobileMenuOpen(false); navigate('/personnel-register'); window.scrollTo(0,0); }}>
             Register as Personnel
           </Typography>
        </Box>
      </Drawer>
