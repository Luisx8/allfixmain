...
<<<<<<< HEAD
      ...
      >
        <div style={{ fontSize: '0.65rem', fontWeight: 900, letterSpacing: '0.05em', textTransform: 'uppercase', padding: '4px 8px', borderRadius: '9999px', backgroundColor: 'rgba(255,255,255,0.15)', color: '#fff' }}>
          {service.brand}
        </div>
...
<<<<<<< HEAD
      <div style={{ padding: '16px', minHeight: '280px', display: 'flex', flexDirection: 'column' }}>
        ...
        <p style={{ fontSize: '0.8rem', color: '#666', lineHeight: 1.5, marginBottom: '16px', flex: 1 }}>{service.description}</p>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px 8px', marginBottom: '20px' }}>
          {service.services.map((tag) => (
            <div key={tag} style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
              ...
              <span style={{ fontSize: '0.7rem', fontWeight: 500, color: service.pillText }}>{tag}</span>
            </div>
          ))}
        </div>
