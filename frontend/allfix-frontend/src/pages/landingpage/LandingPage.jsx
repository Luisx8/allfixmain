...
  import Inventory2Icon from '@mui/icons-material/Inventory2'; // MoveFix (Box)
  import SpaIcon from '@mui/icons-material/Spa'; // GreenFix (Leaf)
  import FavoriteBorderIcon from '@mui/icons-material/FavoriteBorder'; // HealthFix (Heart)
  import HomeOutlinedIcon from '@mui/icons-material/HomeOutlined'; // SpaceFix (House)
  import PetsIcon from '@mui/icons-material/Pets'; // PetFix (Paw)
  import MemoryIcon from '@mui/icons-material/Memory'; // TechFix (Microchip)
...
      image: 'https://via.placeholder.com/350x200?text=SaniFix',
      accent: '#2E5BA8',
      accentDark: '#10355f',
      headerBg: '#10355f',
      headerBgLight: '#2E5BA8',
...
      image: 'https://via.placeholder.com/350x200?text=HomeFix',
      accent: '#2E5BA8',
      accentDark: '#10355f',
      headerBg: '#10355f',
      headerBgLight: '#2E5BA8',
...
      image: 'https://via.placeholder.com/350x200?text=GreenFix',
      accent: '#2E5BA8',
      accentDark: '#10355f',
      headerBg: '#10355f',
      headerBgLight: '#2E5BA8',
...
      image: 'https://via.placeholder.com/350x200?text=HealthFix',
      accent: '#2E5BA8',
      accentDark: '#10355f',
      headerBg: '#10355f',
      headerBgLight: '#2E5BA8',
...
      image: 'https://via.placeholder.com/350x200?text=SpaceFix',
      accent: '#2E5BA8',
      accentDark: '#10355f',
      headerBg: '#10355f',
      headerBgLight: '#2E5BA8',
...
                  <Typography sx={{ color: '#23406e', fontSize: { xs: '0.85rem', md: '0.9rem' }, mb: { xs: 2, md: 0 } }}>Need professional property care? Book with our trusted team across Metro Manila today.</Typography>
                </Box>
